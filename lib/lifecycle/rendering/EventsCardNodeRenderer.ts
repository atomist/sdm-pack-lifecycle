...
export class EventsCardNodeRenderer extends AbstractIdentifiableContribution
    ...
    private renderRelease(events: any, msg: CardMessage, repo: any): void {
    ...
    private renderTag(events: any, msg: CardMessage, repo: any): void {
    ...
    private renderCommits(events: any, msg: CardMessage, repo: any): void {
    ...
    private renderStatus(events: any, msg: CardMessage): void {
    ...
    private renderBuild(events: any, msg: CardMessage): void {
